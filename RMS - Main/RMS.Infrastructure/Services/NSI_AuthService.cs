...
public class NsiAuthService(ApplicationUserManager userManager, IOptions<NSI_JwtConfiguration> jwtOptions) : IAuthService
{
    
    private readonly NSI_JwtConfiguration _jwtConfiguration = jwtOptions.Value;
